...
export const careerRoles: CareerRole[] = [
  {
    ...
    summary: 'Building a next generation trading card game (TCG) focused inventory management system for sellers.',
    highlights: [
  ...
  },
  {
    ...
    summary: 'Led a team of architects and principal engineers for Canvas LMS and related ed-tech products.',
    highlights: [
  ...
  },
  {
    ...
    summary: 'Led the Orders Aggregation team, building solutions to empower sellers to succeed by helping them throughout their entire business lifecycle.',
    highlights: [
  ...
  },
  {
    ...
    summary: 'Led the Kibo eCommerce platform development team after acquisition of Mozu.',
    highlights: [
  ...
  },
  {
    ...
    summary: 'Built search, messaging, event bus, and core catalog systems for a modern SaaS commerce platform.',
    highlights: [
  ...
  },
  {
    ...
    summary: 'Consulted on multiple Dell initiatives with architecture and implementation support.',
    highlights: [
  ...
  },
  {
    ...
    summary: 'Led the eDell search team and built a new search platform for Dell.com.',
    highlights: [
  ...
  },
  {
    ...
    summary: 'Developed enterprise collaboration software including Community Server and Graffiti CMS. Acquired by Verint.',
    highlights: [
  ...
  },
  {
    ...
    highlights: ['Designed and developed student loan origination, management, and disbursement systems system that eliminated many manual tasks and greatly decreased processing time.']
  }
];
